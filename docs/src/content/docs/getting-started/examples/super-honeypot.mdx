---
title: Super Honeypot
description: A Super Honeypot application, managing deposits, withdrawals, and balance inspections for various token standards.
---
...
The SuperHoneypot application is a robust example that demonstrates handling deposits, withdrawals, and balance inspections for Ether, ERC20, ERC721, and ERC1155 tokens using the Crabrolls framework. This document details the application's usage, including how to send JSON-based inputs and inspect outputs. You can find the source code in the [CrabRolls repository](https://github.com/crabrolls-cartesi/crabrolls/blob/main/examples/super_honeypot.rs).
...
Now you can view the vouncher in the `Cartesi Explorer` and execute the withdrawal.
