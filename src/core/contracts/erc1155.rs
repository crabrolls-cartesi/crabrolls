...
impl ERC1155Wallet {
    ...
    pub fn set_balance(
        ...
        if amount.is_zero() {
            ...
            self.balances
                .insert((owner, token_address, token_id), amount);
        }
    }
    ...
    pub fn single_deposit(
        &mut self,
        payload: Vec<u8>,
    ) -> Result<(Deposit, Vec<u8>), Box<dyn Error>> {
        ...
        I: IntoIdsAmountsIter,
    {
        ...
        match deposits.len() {
            1 => {
                ...
                abi::erc1155::single_deposit_payload(
                    wallet_address,
                    token_address,
                    token_id,
                    amount,
            ...
            _ => abi::erc1155::batch_deposit_payload(
                wallet_address,
                token_address,
        ...
        I: IntoIdsAmountsIter,
    {
        ...
        let result = abi::erc1155::batch_withdraw(
            dapp_address,
            wallet_address,
            withdrawals,
...
mod tests {
    ...
    fn test_set_balance() {
        ...
        assert_eq!(
            wallet.balance_of(owner, token_address, token_id),
            Uint::zero()
        );
    }
    ...
    fn test_transfer() {
        ...
        assert!(wallet
            .transfer(
                ...
                dst_wallet,
                token_address,
                vec![(token_id, transfer_amount)]
            )
            .is_ok());
        assert_eq!(
            wallet.balance_of(src_wallet, token_address, token_id),
            transfer_amount
        );
        assert_eq!(
            wallet.balance_of(dst_wallet, token_address, token_id),
            transfer_amount
        );
    ...
    fn test_single_deposit() {
        ...
        let payload =
            ERC1155Wallet::deposit_payload(wallet_address, token_address, (token_id, amount))
                .expect("deposit payload");
    ...
    fn test_batch_deposit() {
        ...
        let payload =
            ERC1155Wallet::deposit_payload(wallet_address, token_address, deposits.clone())
