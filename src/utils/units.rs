...
mod tests {
	...
	fn test_to_ether_large_value() {
		let wei_value = Uint::from(1_000_000_000_000_000_000_000_000u128); // 1,000,000 ether
		let ether_value = wei::to_ether(wei_value);
	...
	fn test_from_ether() {
		...
		assert_eq!(wei_value, Uint::from(1_000_000_000_000_000_000u128));

		let ether_value = 2.0;
		let wei_value = wei::from_ether(ether_value);
		assert_eq!(wei_value, Uint::from(2_000_000_000_000_000_000u128));
	}
	...
	fn test_from_ether_small_value() {
		...
		let wei_value = wei::from_ether(ether_value);
		assert_eq!(wei_value, Uint::from(1_000_000_000_000_000u128));
	}
	...
	//	let wei_value = wei::from_ether(ether_value);
	//	assert_eq!(wei_value, Uint::from(1_000_000_000_000_000_000_000_000u128));
	//}

	#[test]
	fn test_to_gwei() {
		let wei_value = Uint::from(1_000_000_000u64);
		let gwei_value = wei::to_gwei(wei_value);
		assert_eq!(gwei_value, 1.0);

		let wei_value = Uint::from(2_000_000_000u64);
		let gwei_value = wei::to_gwei(wei_value);
	...
	fn test_to_gwei_small_value() {
		let wei_value = Uint::from(500_000_000u64); // 0.5 Gwei
		let gwei_value = wei::to_gwei(wei_value);
	...
	fn test_to_gwei_large_value() {
		let wei_value = Uint::from(1_000_000_000_000_000_000u128); // 1,000,000,000 Gwei
		let gwei_value = wei::to_gwei(wei_value);
	...
	fn test_from_gwei() {
		...
		assert_eq!(wei_value, Uint::from(1_000_000_000u128));

		let gwei_value = 2.0;
		let wei_value = wei::from_gwei(gwei_value);
		assert_eq!(wei_value, Uint::from(2_000_000_000u128));
	}
	...
	fn test_from_gwei_small_value() {
		let gwei_value = 0.5;
		let wei_value = wei::from_gwei(gwei_value);
		assert_eq!(wei_value, Uint::from(500_000_000u128));
	}
